...
void main() {
  group('Mock Authentication', () {
    ...
    test(
      'user should be initialized in less than 2 secondes',
      () async {
        await provider.intialize();
        expect(provider.isInitialized, true);
      },
    ...
    test('create user should delegate to logIn function', () async {
      final badEmailUser =
          provider.createUser(email: 'foo@bar.com', password: 'randompassword');
      expect(badEmailUser,
          throwsA(const TypeMatcher<UserNotFoundAuthException>()));
      final badPasswordUser =
          provider.createUser(email: 'random@bar.com', password: 'foobar');
